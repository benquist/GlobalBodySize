#!/usr/bin/env Rscript
# providers/manual_intake/scripts/download_occurrence_sources.R
#
...
# ---------------------------------------------------------------------------
# TASK 4 — Update harvest_status in manual_source_intake.csv
# ---------------------------------------------------------------------------
cat("\n=== Updating harvest_status in manual_source_intake.csv ===\n")

intake_path <- file.path(project_root, "data", "manual_source_intake.csv")
