...
- **`BIEN-SpeciesShinyApp/`** — standalone BIEN app repository checkout for occurrence, trait, range, provenance, and QA review.
...
- The canonical standalone repository for the BIEN app is `https://github.com/benquist/BIEN-SpeciesShinyApp`.
