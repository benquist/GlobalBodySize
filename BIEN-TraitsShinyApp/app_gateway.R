  ...
  moduleServer(id, function(input, output, session) {
    ...
    output$dl_script <- downloadHandler(
      ...
      content = function(file) {
        ...
        script <- c(
          "# =============================================================",
          "# Reproducible BIEN query script",
          "# Generated by BIEN Trait Data Gateway",
          ...
          "#   Enquist BJ et al. (2026). \"BIEN: A biodiversity informatics ecosystem",
          "#   advancing open and reproducible workflows for plant observation, plot,",
          "#   and trait data.\" Methods in Ecology and Evolution (early view).",
          "#   doi: pending — run citation(\"BIEN\") in R for the current package citation.",
          "# =============================================================",
          "",
          "# \u2500\u2500 1. Install / load packages \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500",
          "# install.packages(\"BIEN\")   # uncomment if not installed",
          "library(BIEN)",
          "library(dplyr)",
          "",
          "# \u2500\u2500 2. Query parameters \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500",
          "# Rank and taxon are injected at download time by the Shiny app.",
          ...
          "# source.citation = TRUE returns the bibliographic source for each record.",
          "# all.taxonomy   = TRUE returns the full taxonomic hierarchy.",
          "# Use citation(\"BIEN\") in R for the current package citation.",
          sprintf("dat <- %s", call_line),
          "",
          "# \u2500\u2500 4. Apply trait filter (if Step 3 filter was active in the app) \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500",
          selected_traits_r,
          "",
          "# \u2500\u2500 5. Inspect \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500",
          ...
          "",
          "# \u2500\u2500 6. Export \u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500\u2500",
          "# The source_citation and url_source columns in the CSV trace each record",
          "# back to its primary data source. Cite those sources in any publication.",
